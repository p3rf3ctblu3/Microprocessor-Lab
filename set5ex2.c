...
int main(void)
{
	...
	PCA9555_0_write(REG_CONFIGURATION_1, 0xF7);     // Set IO1_0 as output and the rest as input (set)
	...
	while(1)
	{
		...
		if (input == 0b11100111) PCA9555_0_write(REG_OUTPUT_0, 0x01);         // Pressed '*'
		else if (input == 0b11010111) PCA9555_0_write(REG_OUTPUT_0, 0x02);    // Pressed '0'
		else if (input == 0b10110111) PCA9555_0_write(REG_OUTPUT_0, 0x04);    // Pressed '#'
		else if (input == 0b01110111) PCA9555_0_write(REG_OUTPUT_0, 0x08);    // Pressed 'D'
	}
}